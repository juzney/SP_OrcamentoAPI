...
module.exports = {
    ...
    async Store(req, res){
        const { firstName, lastName, city, celPhone, companyName, companyArea, email, serviceTipe, description} = req.body
    
        try{
            const orcamento = new Orcamento({
                firstName, lastName, city, celPhone, companyName, companyArea, email, serviceTipe, description
            })
        ...
        {
            return res.status(400).send({ "erro": "Orcamento unsaved" })
